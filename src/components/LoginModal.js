...
const LoginModal = () => {
    ...
    return (
        <>
            <div className={`${login ? ' block' : 'hidden'} w-screen h-screen bg-black/[.5] flex items-center justify-center z-50 fixed left-0`}>
                <div className='w-9/12 lg:w-5/12 relative h-5/6 bg-white text-black rounded-xl overflow-auto'>
                    ...
                    <div className='px-4 mt-16'>
                        ...
                        <div className='flex flex-col border-[1px] rounded-xl p-2 rounded-t-none'>
                            ...
                            <input type='tel' placeholder='(+234)' className='outline-0' value={phone} onChange={(e) => setPhone(e.target.value)} />
                        </div>
