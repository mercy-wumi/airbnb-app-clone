            ...
            <div className='w-2/3 lg:w-1/3 relative bg-white text-black h-auto rounded-xl'>
                ...
                <div className='px-4 mt-16 py-8'>
                    ...
                    <div className='flex items-center w-full'>
                        {imgUrl && <img src={imgUrl} alt='profile picture' className='w-1/2 rounded-full' />}
                        {!imgUrl && <UserCircleIcon className='w-1/2 m-auto' />}
                    </div>
                    <input type='file' accept="image/*" onChange={handleImgChange} className=' w-full flex justify-center items-center bg-black text-white rounded-xl border-0' />
