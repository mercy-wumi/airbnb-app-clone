                ...
                <div className='flex flex-col justify-between ml-4 flex-1'>
                    <div className='flex flex-col'>
                        <div className='flex items-center justify-between'>
                            <div className='flex flex-col'>
                                ...
                                <span className='font-semibold text-sm md:text-lg lg:text-xl'>Le MICA (Chalets Micro-Element) CITQ 303134</span>
                            </div>
                    ...
                    <div className='flex justify-between items-center flex-wrap'>
                        ...
                        <div className='flex items-center'>
                            <span className='md:text-xl lg:text-2xl font-semibold'>$249</span>
                            <span>night</span>
                        </div>
                    </div>
                </div>
